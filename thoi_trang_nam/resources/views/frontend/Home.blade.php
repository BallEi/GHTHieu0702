                            ...
                            @foreach ($productSale as $proSale)
                                <li class="prod-i">
                                    <div class="prod-i-top">
                                        <a href="{{ route('client.product_detail', $proSale->id) }}" class="prod-i-img"><!-- NO SPACE --><img src="{{ Storage::url('images/'.$proSale->Anh) }}" alt="Aspernatur excepturi rem"><!-- NO SPACE --></a>
        ...
        <div class="discounts-wrap">
            ...
            <div class="prod-items section-items">
                @foreach ($productNews as $proNew)
                    <div class="prod-i">
                        <div class="prod-i-top">
                            <a href="{{ route('client.product_detail', $proNew->id) }}" class="prod-i-img"><!-- NO SPACE --><img src="{{ Storage::url('images/'.$proNew->Anh) }}" alt="Adipisci aperiam commodi"><!-- NO SPACE --></a>
