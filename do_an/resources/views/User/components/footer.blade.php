<section class="footer">
    <div class="footer-container">
        ...
        <div class="app-google">
            <a href=""><img src="{{asset('ivymoda\image\appstore.jpg')}}" alt=""></a>
            <a href=""> <img src="{{asset('ivymoda\image\googleplay.jpg')}}" alt=""></a>
        </div>
        ...
        <div class="footer-items">
            <li><a href=""><img src="{{asset('ivymoda\image\dathongbao.png')}}" alt=""></a></li>
